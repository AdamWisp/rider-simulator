...
def main():
    ...
    if st.sidebar.button("Start Simulation"):
        ...
        # 1. Instructor always does one whole lap at t=0
        ...
        # 2. EXP: run each selected phase in fixed order
        for ph in phases:
        ...
        # 3. FOC: only after EXP completes all phases
        for ph in phases:
